...
Response functions are general techniques that maps a change in an output variable to a temporary change in parameters \cite{Rand2004}.
...
\begin{figure}[tbp]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{chap5/figures/figure_1_b.pdf}
  \end{center}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.9\textwidth]{chap5/figures/figure_2.pdf}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=.9\textwidth]{chap5/figures/figure_3.pdf}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=.9\textwidth]{chap5/figures/figure_S2.pdf}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=.9\textwidth]{chap5/figures/figure_4.pdf}
...
\begin{figure}[tbp]
  \centering
    \includegraphics[width=.9\textwidth]{chap5/figures/figure_5.pdf}
...
The following chapter discusses how population-level recordings, even those from high-throughput circadian screens, can be used to gain estimates of stochastic noise at the single-cell level. 
