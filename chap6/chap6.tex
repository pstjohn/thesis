...
Arising perhaps from a single dose of drug which is quickly cleared from the body, temporary perturbations are promising routes for increasing amplitude in peripheral tissues.
However, because of the experimental difficulty associated with studying such perturbations in high-throughput studies, most research has focused on studying the effects of constant concentrations of drugs or gene knockdowns.
This chapter takes a closer look at the insight into clock kinetics which might be gained from such studies, specifically with regard to transcriptional noise.
...
\begin{figure}[tbp]
  \begin{center}
    \includegraphics[width=0.8\textwidth]{chap6/figures/noise_ts_and_boot.pdf}
  \end{center}
...
\begin{figure}[tbp]
  \begin{center}
    \includegraphics[width=0.6\textwidth]{chap6/figures/main_fig_simulations_b.pdf}
  \end{center}
...
\begin{figure}[tbp]
  \begin{center}
    \includegraphics[width=0.65\textwidth]{chap6/figures/outliers.pdf}
  \end{center}
...
\begin{figure}[tbp]
  \begin{center}
    \includegraphics[width=0.7\textwidth]{chap6/figures/FigS5.pdf}
  \end{center}
...
\begin{figure}[tbp]
  \begin{center}
    \includegraphics[width=0.7\textwidth]{chap6/figures/FigS6.pdf}
  \end{center}
  \titlecaption{Period heterogeneity and phase diffusion display different damping profiles}{({\itshape Left}) A simulated population of homogeneous, noisy oscillators dephases due to cycle-to-cycle variability. The envelope of the averaged expression is proportional to $t$.
