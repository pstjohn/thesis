...
Full model equations for the model from Hirota {\itshape et al.}, 2012 are shown in \fref{tab:modelfns}, the model from Rel\'{o}gio {\itshape et al.} 2011 in \fref{tab:relogioeqs}, and the model from Leloup \& Goldbeter, 2003 in \fref{tab:leloupeqs}.

\begin{table}[p]
  \centering
  \titlecaption{Model equations for the model from Rel\'{o}gio {\itshape et al.} 2011 \cite{Relogio2011}}{}
...
\begin{table}[p]
  \centering
  \titlecaption{Model equations for the model from Leloup \& Goldbeter, 2003 \cite{Leloup2003}}{}
  \label{tab:leloupeqs}
  \footnotesize
